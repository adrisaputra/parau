...
class PengaturanController extends Controller
{
    ...
    public function update(Request $request, Pengaturan $pengaturan)
    {
        ...
        if ($request->file('foto_kepala_dinas') && $pengaturan->foto_kepala_dinas) {
            $pathToYourFile = public_path('upload/pengaturan/' . $pengaturan->foto_kepala_dinas);
            if (file_exists($pathToYourFile)) {
                unlink($pathToYourFile);
            }
        }
        ...
        if ($request->file('foto_kepala_dinas') == "") {
            ...
            $request->foto_kepala_dinas->move(public_path('upload/pengaturan'), $filename);
            $pengaturan->foto_kepala_dinas = $filename;
        }
