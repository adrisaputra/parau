								...
								<form class="row">
									...
									<div class="col s12">
										...
										<div class="input-field col s12">
											...
											<input type="text" id="group_name" name="group_name" value="{{ $group->group_name }}" style="@if ($errors->has('group_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
