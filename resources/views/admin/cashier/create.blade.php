...
<div id="main">
	<div class="row">
										...
										<div class="row">
																...
																<div class="col s12">
																	<div class="app-file-header-search">
																		<div class="input-field m-0">
																			<input type="text" id="product_search" onkeyup="searchBox()" placeholder="Pencarian" name="search" style="border-bottom: 1px solid #e2dfdf;" autofocus>
																		</div>
																	</div>
																</div>
															</div>
											...
											<div id="modal1" class="modal modal-fixed-footer">
												<div class="modal-content">
													...
													<div id="view-input-fields">
														<div class="row">
															...
															<div class="input-field col s6">
																<label for="dtl-user">{{ __('Uang Bayar (Rp.):') }}</label>
																<input type="text" id="pay_cost" value="" oninput="kembalian(this.value)">
															</div>
												...
												<div class="modal-footer">
													...
													<button onclick="confirm()" class="btn green darken-2 btn-flat" style="width:100%; color:white;">
														<b>Bayar</b>
													</button>
												</div>
											</div>
											...
											<div class="col s12 m4 l4">
												...
												{{-- <div class="input-field col s12">
													<select class="select2 browser-default" name="status" id="member_id" required onchange="$('#bayar-member').val(this.options[this.selectedIndex].text);">
		...
		<div style="bottom: 90px; right: 19px;" class="fixed-action-btn direction-top">
			<a class="btn-floating btn-large modal-trigger green darken-2" href="#modal1" {{-- onclick="call_modal()" --}}><i class="material-icons">add_shopping_cart</i>Modal</a>
			{{-- <button onclick="confirm()" class="btn-floating btn-large waves-effect waves-light green darken-2"><i class="material-icons">save</i></button> --}}
...
<script>
    ...
    url = "{{ url('/cashier/get_modal_data') }}"
    $.ajax({
        url:""+url+"?id="+id+"",
        success: function(response){
