                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s12 " style="overflow-x:auto;">
                                                <table class="highlight">
                                                    ...
                                                    <tbody>
                                                        @foreach ($sellingTransaction as $v)
...
@section('script')
<script script src="{{ asset('/assets/cashier/js/helper-po.js') }}"></script>
<script script src="{{ asset('/assets/cashier/js/cashier.js') }}"></script>
@endsection