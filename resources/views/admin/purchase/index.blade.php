        ...
        <div class="col s12">
            <div class="container">
                                                ...
                                                <table class="highlight">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>{{ $row->purchase_detail->count() }}</td>
                ...
                <div style="bottom: 40px; right: 19px;" class="fixed-action-btn direction-top">
                    @can('tambah-data')
                    <a href="{{ url('/preorder') }}" class="btn-floating btn-large waves-effect waves-light green darken-2"><i class="material-icons">add</i></a>
                    @endcan
