								...
								<form class="row">
									...
									<div class="col s12">
										<div class="input-field col s12">
											...
											<input type="text" id="category_name" name="category_name" value="{{ old('category_name') }}" style="@if ($errors->has('category_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
