      ...
      <div class="row">
        ...
        <div class="breadcrumbs-dark pb-0 pt-2" id="breadcrumbs-wrapper">
          ...
          <div class="container">
	   	...
	   	<form action="{{ url('/'.Request::segment(1).'/edit/'.$category->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
								...
								<form class="row">
									...
									<div class="col s12">
										<div class="input-field col s12">
											...
											<input type="text" id="category_name" name="category_name" value="{{ $category->category_name }}" style="@if ($errors->has('category_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
											@if ($errors->has('category_name'))<small><div class="error">{{ $errors->first('category_name') }}</div></small>@endif
										</div>
									</div>
								</form>
							</div>
