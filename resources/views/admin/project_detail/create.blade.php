								...
								<form class="row">
									<p style="text-align:center;font-size:20px;font-weight:bold">Tambah {{ __($title) }}</p>
										...
										<div class="input-field col s6">
											...
											<input type="text" id="work_name" name="work_name" value="{{ old('work_name') }}" style="@if ($errors->has('work_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s6">
											...
											<input type="text" id="service_value" name="service_value" value="{{ old('service_value') }}" onkeyup="formatRupiah(this, '.')" style="@if ($errors->has('service_value'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s6">
											...
											<input type="text" id="volume" name="volume" value="{{ old('volume') }}" style="@if ($errors->has('volume'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s4">
											...
											<input type="text" id="work_start" onChange="getNumberOfDays()" class="datepicker" name="work_start" value="{{ old('work_start') }}" style="@if ($errors->has('work_start'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s4">
											...
											<input type="text" id="work_end" onChange="getNumberOfDays()" class="datepicker2" name="work_end" value="{{ old('work_end') }}" style="@if ($errors->has('work_end'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s4">
											...
											<input type="text" id="estimation" name="estimation" value="@if(old('estimation')){{ old('estimation') }} @else 0 @endif" readonly style="color:black">
										</div>
										...
										<div class="input-field col s12">
											<select class="select2 browser-default" name="team_id" id="team_id">
												...
												@foreach($team as $v)
													<option value="{{ $v->id }}" @if(old('team_id')=="$v->id") selected @endif>{{ $v->team_name }}</option>
												@endforeach
											</select>
