        ...
        <div class="col s12">
          <div class="container">
								...
								<form class="row">
									...
									<div class="col s12">
										...
										<div class="input-field col s12">
											...
											<input type="text" id="sub_menu_name" name="sub_menu_name" value="{{ old('sub_menu_name') }}" style="@if ($errors->has('sub_menu_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
			...
			<div style="bottom: 90px; right: 19px;" class="fixed-action-btn direction-top">
				...
				<a href="{{ url('/'.Request::segment(1).'/'.$menu->id) }}" class="btn-floating btn-large waves-effect waves-light red darken-2"><i class="material-icons">arrow_back</i></a>
			</div>
          </div>
		</form>
