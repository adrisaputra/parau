...
<div id="main">
    <div class="row">
        ...
        <form action="{{ url('/' . Request::segment(1) . '/edit/' . $outlet->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            {{ csrf_field() }}
                                                ...
                                                <form class="row">
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <label for="outlet_name">{{ __('Nama Outlet') }}</label>
                                                            <input type="text" id="outlet_name" name="outlet_name" value="{{ $outlet->outlet_name }}" style="@if ($errors->has('outlet_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
                                                            @if ($errors->has('outlet_name'))<small>
                                                                <div class="error">{{ $errors->first('outlet_name') }}</div>
                                                            </small>@endif
                                                        </div>
                                                        <div class="input-field col s12">
                                                            <label for="phone">{{ __('Nomor Telepon') }}</label>
                                                            <input type="text" id="phone" name="phone" value="{{ $outlet->phone }}" style="@if ($errors->has('phone'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
                                                        ...
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input type="text" id="address" name="address" value="{{ $outlet->address }}" style="@if ($errors->has('address'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
                                                        ...
                                                        <div class="input-field col s12">
                                                            ...
                                                            <div id="xmap3"></div>
                                                            <input type="hidden" name="lat" id="latclicked" class="form-control" value="{{ $outlet->lat }}" readonly>
                                                            <input type="hidden" name="long" id="longclicked" class="form-control" value="{{ $outlet->long }}" readonly>
                                                        </div>

                                                        <div class="input-field col s12">
                                                            <label for="description">{{ __('Deskripsi') }}</label>
                                                            <input type="text" id="description" name="description" value="{{ $outlet->description }}" style="@if ($errors->has('description'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
