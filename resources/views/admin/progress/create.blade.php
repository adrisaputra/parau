								...
								<form class="row">
									...
									<div class="col s12">
										...
										<div class="input-field col s12">
											...
											<input type="text" id="project_name" name="project_name" value="{{ old('project_name') }}" style="@if ($errors->has('project_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
