      ...
      <div class="row">
        ...
        <div class="breadcrumbs-dark pb-0 pt-2" id="breadcrumbs-wrapper">
          ...
          <div class="container">
	   	...
	   	<form action="{{ url('/'.Request::segment(1).'/edit/'.$project->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
								...
								<form class="row">
									...
									<div class="col s12">
										...
										<div class="input-field col s12">
											<label for="project_name">{{ __('Nama Project') }} <span class="required" style="color: #dd4b39;">*</span></label>
											<input type="text" id="project_name" name="project_name" value="{{ $project->project_name  }}" style="@if ($errors->has('project_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
											@if ($errors->has('project_name'))<small><div class="error">{{ $errors->first('project_name') }}</div></small>@endif
										</div>

										<div class="input-field col s12">
											<label for="client_name">{{ __('Nama Client') }} <span class="required" style="color: #dd4b39;">*</span></label>
											<input type="text" id="client_name" name="client_name" value="{{ $project->client_name }}" style="@if ($errors->has('client_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s12">
											...
											<input type="text" id="phone" name="phone" value="{{ $project->phone }}" style="@if ($errors->has('phone'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s12">
											...
											<input type="text" id="address" name="address" value="{{ $project->address }}" style="@if ($errors->has('address'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s12">
											...
											<div id="xmap3"></div>
											<input type="hidden" name="lat" id="latclicked" class="form-control" value="{{ $project->lat }}" readonly>
											<input type="hidden" name="long" id="longclicked" class="form-control" value="{{ $project->long }}" readonly>
										</div>
...
<script>
      ...
      function initAutocomplete() {
		...
		var myLatlng = new google.maps.LatLng({{ $project->lat }}, {{ $project->long }});
