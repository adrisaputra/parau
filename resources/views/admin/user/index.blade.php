												...
												<table class="highlight">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																@if ($v->group_id==1)
																<span class="new badge red" data-badge-caption="{{ $v->group->group_name}}"></span>
																@elseif ($v->group_id==2)
																<span class="new badge orange" data-badge-caption="{{ $v->group->group_name}}"></span>
																@elseif ($v->group_id==3)
																<span class="new badge blue" data-badge-caption="{{ $v->group->group_name}}"></span>
																@elseif ($v->group_id==4)
																<span class="new badge green" data-badge-caption="{{ $v->group->group_name}}"></span>
																@else
