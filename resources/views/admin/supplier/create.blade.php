                                                    ...
                                                    <form class="row">
                                                        ...
                                                        <div class="col s12">
                                                            <div class="input-field col s12">
                                                                <label for="supplier_name">{{ __('Nama Supplier') }}</label>
                                                                <input type="text" id="supplier_name" name="supplier_name" value="{{ old('supplier_name') }}" style="@if ($errors->has('supplier_name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
